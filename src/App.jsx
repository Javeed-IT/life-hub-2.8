...
import ILR from './components/ILR.jsx'
import Reading from './components/Reading.jsx'
import Notes from './components/Notes.jsx'

const TABS = ['Home','Finance','Trends','Diet','Health','Career','ILR','Reading','Notes','Settings']
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-4 justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-white/70">v2.8 · Finances · Career · ILR · Reading</div>
            </div>
          </div>
